...
type WorkerStruct struct {
	Internal struct {
		AddPiece func(p0 context.Context, p1 storage.SectorRef, p2 []abi.UnpaddedPieceSize, p3 abi.UnpaddedPieceSize, p4 storage.Data, p5 bool) (storiface.CallID, error) `perm:"admin"`
...
func (s *WorkerStruct) AddPiece(p0 context.Context, p1 storage.SectorRef, p2 []abi.UnpaddedPieceSize, p3 abi.UnpaddedPieceSize, p4 storage.Data, p5 bool) (storiface.CallID, error) {
	if s.Internal.AddPiece == nil {
		return *new(storiface.CallID), ErrNotSupported
	}
	return s.Internal.AddPiece(p0, p1, p2, p3, p4, p5)
}

func (s *WorkerStub) AddPiece(p0 context.Context, p1 storage.SectorRef, p2 []abi.UnpaddedPieceSize, p3 abi.UnpaddedPieceSize, p4 storage.Data, p5 bool) (storiface.CallID, error) {
	return *new(storiface.CallID), ErrNotSupported
}
